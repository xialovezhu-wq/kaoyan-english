...
- 用户长期库词项：826
- 用户证据标签候选：错句来源 333，错题来源 12（均不等于“用户明确不会”）
- 句式卡：25
...
| `learner_bank_item` | 826 |
| `learner_evidence` | 345 |
| `reference_source` | 7 |
...
| `HAS_FORM` | 46 |
| `HAS_FUNCTION` | 25 |
| `HAS_LEARNER_EVIDENCE` | 345 |
| `HAS_SCENE` | 65 |
| `HAS_THEME` | 46 |
| `LEARNER_TOKEN_MATCHES_SYLLABUS` | 804 |
...
- `bank/master_bank.csv`：`0b28ba94eeeda40d5a7c06f3f8796e550aeafa9f9816f23a55df49f151f432f5`
- `bank/mastered_items.csv`：`a098f71b721db1cc08e6ef2ede846c01b962316c4d14b5494735af9152983bf2`
- `bank/sentence_patterns.md`：`24ffd7fa08643d273ea0284a04cb8b3360cd4e844065afd351a4d41ddba3afaf`
